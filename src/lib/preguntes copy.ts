export const PREGUNTES = {
  tema0: [
    ...
    {
      pregunta:
        "A quin dels subsistemes d'una organització dona suport el subsistema d'informació?",
      opcions: [
        'Només al de producció',
        'Només al de decisió',
        'A tots dos',
        'A cap dels dos',
      ],
    ...
    {
      pregunta:
        "¿Les consultes de quin tipus de sistema d'informació accedeixen, en general, més tuples?",
      opcions: ['Operational', 'Decisional'],
      correcta: 1,
    },
    {
      pregunta:
        "¿Quin tipus de sistema d'informació utilitza menys fonts de dades?",
      opcions: ['Decisional', 'Operational'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "¿Quin tipus de sistema d'informació utilitza principalment dades històriques?",
      opcions: ['Decisional', 'Operational'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        "Per a quin tipus de sistemes d'informació és rellevant el seu rendiment (performance)?",
      opcions: [
        'Només operationals',
        'Només decisionals',
        'Tots dos',
    ...
    {
      pregunta:
        'Quin NO és una de les tres fases principals del disseny de bases de dades?',
    ...
    {
      pregunta:
        "El disseny de la base de dades relacional per a un sistema d'informació segueix els mateixos tres passos, independentment que aquest sigui operacional o decisional.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        "¿Quin tipus de sistema d'informació ha de gestionar un volum de dades més gran?",
      opcions: ['Decisional', 'Operational'],
      correcta: 0,
    },
    {
      pregunta:
        "La diferència en la fase de disseny conceptual d'un sistema operacional i un decisional és que l'operacional utilitza qualsevol estructura de classes i interrelacions, mentre que el decisional utilitza una molt concreta.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "La diferència en la fase de disseny lògic d'un sistema operacional i un decisional és que el decisional utilitza qualsevol estructura de taules i restriccions d'integritat, mentre que l'operacional utilitza una molt concreta.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Es fonamental que l'esquema lògic l'entenguin els usuaris del sistema.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
  ...
  tema1: [
    ...
    },
    {
      ...
      opcions: [
        "Control de rendiment (monitorització i pla d'accés)",
        'Afinació (Tuning)',
        'Quantificació de volums i freqüències',
        'Consideracions respecte a temps de resposta, concurrència, recuperació i seguretat',
      ],
      correcta: 0,
    },
    {
      ...
      opcions: [
        'Dues taules amb dades equivalents, però amb noms diferents',
        'Dos procediments emmagatzemats que fan el mateix, però en llenguatges de programació diferents',
        'Dues classes del mateix concepte, però amb noms diferents',
        'Dos atributs que representen el mateix valor, però en unitats de mesura diferents',
      ],
      correcta: 1,
    },
    {
      ...
      opcions: [
        'Per a poder inserir una tupla amb un valor desconegut',
        'Per a afegir una columna a una taula que no està buida',
        "Per no haver de tractar casos especials en les funcions d'agregació",
        'Per a poder inserir una tupla amb un valor que mai pot tenir',
      ],
      correcta: 3,
    },
    {
    ...
    },
    {
      ...
      opcions: [
        'Un valor nul ocupa el mateix espai que qualsevol altre valor',
        'El valor nul dividit per zero dóna error',
        "Un nul igualat amb ell mateix ('NULL=NULL') avalua cert",
    ...
    },
    {
      pregunta: 'Quina afirmació és certa?',
      opcions: [
        "Una tupla que avalua el predicat d'un CHECK a 'desconegut' viola la restricció d'integritat",
        "Una tupla que avalua el predicat del WHERE a 'desconegut' surt al resultat de la consulta",
        "Una tupla que té un valor null a la clau forana viola la restricció d'integritat",
        'Cap de les anteriors afirmacions és certa',
      ],
      correcta: 3,
    },
    {
      pregunta:
        'Quina de les següents expressions dóna error en SQL estàndard?',
    ...
    {
      pregunta:
        'Quina de les tres implementacions de Generalització/Especialització NO genera mai nuls ni repeteix valors?',
      opcions: [
        "Creació d'una única taula corresponent a la superclasse",
        "Creació d'una taula per cada classe (tant per a la superclasse com per a les subclasses)",
        "Creació d'una taula per cada subclasse, però no per a la superclasse",
        'Cap de les tres, totes poden generar problemes depenent del tipus de Generalització/Especialització',
      ],
      correcta: 1,
    },
    {
    ...
    },
    {
      ...
      opcions: [
        'No existeix una clau externa',
        'Els atributs de la clau externa canvien molt sovint',
        'La clau externa requereix massa espai',
        'Totes ho són',
      ],
      correcta: 3,
    },
    {
      pregunta:
        'Una SEQUENCE de PostgreSQL es pot utilitzar a taules diferents.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'El mètode de disseny que utilitzem NO depèn de la mida de la companyia.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'El mètode de disseny que utilitzem és diferent si ja existeix una base de dades prèviament o no.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Per ajudar-nos a entendre millor les multiplicitats de les associacions, podem dibuixar algunes instàncies i les seves interrelacions.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "L'esquema lògic de la base de dades, només hauria de permetre instanciacions correctes de l'esquema conceptual.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Un atribut d'una classe, es pot representar també mitjançant una associació d'aquesta amb una segona classe.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'Parlem de relativisme semàntic només quan els dos (o més) esquemes representen exactament la mateixa realitat.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Parlem de relativisme semàntic només quan els dos (o més) esquemes contenen exactament el mateix nombre de taules.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Utilitzar un zero és equivalent a utilitzar un valor null, sempre que el primer no pertanyi al domini de l'atribut.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Les taules de veritat de lògica binària són un subconjunt de les de lògica ternària, on simplement eliminem les files i columnes que fan referència a 'Desconegut'.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Si a l'entrada de l'operació algebraica d'unió hi ha dues files que només tenen valor null a tots els seus atributs, a la sortida tindré només una fila.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Si a l'entrada de l'operació algebraica d'intersecció hi ha dues files (una a cada taula) que només tenen valor null a tots els seus atributs, a la sortida no apareixerà aquesta fila.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Si a l'entrada de l'operació algebraica de diferència hi ha dues files (una a cada taula) que només tenen valor null a tots els seus atributs, a la sortida no apareixerà aquesta fila.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Si com a resultat d'una operació algebraica de projecció queda més d'una fila que només té valor null a tots els seus atributs, a la sortida apareixerà aquesta fila tantes vegades com la tingues a l'entrada.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Sempre puc implementar una diferència indistintament amb un 'NOT IN' o un 'NOT EXISTS'.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "En qualsevol dels tres tipus d'implementació de Generalització/Especializació posem un atribut discriminant.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "En cap dels tres tipus d'implementació de Generalització/Especializació posem claus foranes.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Quan implementem una Generalització/Especializació en un SGBD relacional, sempre cal fer una join per consultar juntes totes les dades de la superclasse.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Quan implementem una Generalització/Especializació en un SGBD relacional, sempre cal utilitzar una outer join per consultar juntes totes les dades de qualsevol de les subclasses.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Si una consulta té només dues taules al FROM, podem intercanviar LEFT per RIGHT i obtenir el mateix resultat, simplement canviant a la vegada l'ordre de les taules.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'La FULL OUTER JOIN de dues taules permet obtenir el mateix resultat que una LEFT OUTER JOIN o una RIGHT OUTER JOIN, simplement afegint un cert predicat al WHERE.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "La FULL OUTER JOIN de dues taules és equivalent a fer la unió d'una LEFT OUTER JOIN i una RIGHT OUTER JOIN.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Quan utilitzem la implementació de l'herència en PostgreSQL, quina de les següents afirmacions és certa?",
      opcions: [
        'Només podem inserir dades a la taula de la subclasse',
        'Només podem inserir dades a la taula de la superclasse',
        'Podem inserir dades indistintament a qualsevol de les dues taules i tindrem el mateix resultat',
        'Podem inserir dades a qualsevol de les dues taules, però no tindrem el mateix resultat',
      ],
      correcta: 3,
    },
    {
      pregunta:
        'Un atribut tipus SERIAL sempre tindrà valors consecutius tret que haguem esborrat alguna fila de la taula.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
  ],
  tema2: [
    ...
    {
      pregunta:
        "La clau primària d'una taula sempre genera automàticament un índex B+ associat?",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Un deadlock provocat per claus foranes entre dues taules es pot resoldre creant una tercera taula.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Quina és la millor opció per inserir tuples quan tenim un deadlock provocat per claus foranes entre dues taules?',
      opcions: [
    ...
    {
      pregunta:
        "Què perdem si esborrem una taula que només té l'atribut identificador i una clau forana que l'apunta?",
      opcions: [
    ...
    {
      pregunta:
        'Quin NO és un criteri per a triar la clau primària entre les alternatives que hi hagin?',
      opcions: [
    ...
    {
      pregunta:
        'Quina de les següents afirmacions respecte a les associacions reflexives és falsa?',
      opcions: [
    ...
    {
      pregunta:
        'En una associació reflexiva simètrica, cal guardar a la base de dades les dues versions de la parella.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'Hi ha casos en que podem implementar una associació ternària amb simplement una clau forana (sense cap taula intermitja).',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'En una agregació composta, tots dos costats poden tenir un zero.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Una clau forana de dos atributs és equivalent a dues claus foranes d'un atribut cadascuna.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'A les associacions binàries, només les *-* poden tenir atributs propis.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'Una associació dóna lloc realment a una classe associativa quan...',
      opcions: [
        'Té molts atributs',
    ...
    {
      pregunta:
        'Quan un atribut multivaluat pot tenir molts valors, és millor emmagatzemar-ho per columnes.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Un atribut multivaluat emmagatzemat per columnes ocupa menys espai.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Un atribut multivaluat emmagatzemat per files és més difícil d'agregar.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Un atribut multivaluat emmagatzemat per files permet un grau més alt de concurrència.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Les claus alternatives no tenen una clàusula pròpia a l'estàndard per a crear-les?",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'La millor manera per a resoldre un deadlock provocat per claus foranes entre dues taules, és sempre crear una de les taules sense clau forana i afegir-li a posteriori.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Què és menys important en una associació binària quan fem el disseny conceptual de la base de dades?',
      opcions: [
        'Si la multiplicitat màxima de cada costat',
        'Si la multiplicitat mínima de cada costat',
        "El nom de l'associació",
        'La direcció de navegació',
      ],
      correcta: 3,
    },
    {
      pregunta:
        "En quin tipus d'associació binària és totalment irrellevant si un dels costats admet zeros o no?",
      opcions: ['*-*', '1-*', '1-1', 'Sempre és rellevant'],
      correcta: 0,
    },
    {
      pregunta:
        "Quin tipus d'associació binària s'ha d'implementar sempre amb una taula pròpia (a més de les dues corresponents a les classes)?",
      opcions: ['*-*', '1-*', '1-1', 'Totes les anteriors'],
      correcta: 0,
    },
    {
      pregunta:
        "En quin tipus d'associació binària podem triar a quina taula posem la clau forana?",
      opcions: ['*-*', '1-*', '1-1', 'Totes les anteriors'],
      correcta: 2,
    },
    {
      pregunta:
        "Independentment de les multiplicitats d'una associació binària, sempre hi ha una opció per evitar que es puguin generar valors null.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "El millor és sempre triar la implementació d'una associació binària que no genera mai valors null.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "En el model relacional clàssic, en presència de quin tipus d'associació binària podem fusionar les dues taules en una?",
      opcions: ['*-*', '1-*', '1-1', 'Totes les anteriors'],
      correcta: 2,
    },
    {
      pregunta:
        'En una associació reflexiva simètrica, només pot trobar-se amb multiplicitat 1-1.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Per tal de garantir la simetria d'una associació binària, sempre haurem d'utilitzar triggers.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "La implementació d'una associació ternària en un SGBD relacional mai genera valors null.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Quan en l'esquema conceptual trobem una associació binària, independentment de la multiplicitat, sempre podem transformar-la en una classe que tingui el mateix nom que l'associació i dues associacions amb les classes originals.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Un atribut multivaluat emmagatzemat per files mai genera valors null.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Un atribut multivaluat emmagatzemat per columnes genera un únic accés a disc per recuperar tots els valors.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Sempre podem implementar totes les restriccions d'integritat corresponents a les multiplicitats '1' i '*' de les associacions binàries amb només claus primàries, foranes i 'NOT NULL'.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
  ],
  tema3: [
    {
      pregunta:
        'Quina NO és una conseqüència de les anomalies que motiven la teoria de la normalització?',
      opcions: [
        'Es generen joins innecessàries',
        'Un únic canvi pot provocar moltes modificacions a la base de dades',
        'Algunes dades es poden perdre sense voler',
        'No podem inserir una certa dada de forma independent',
      ],
      correcta: 0,
    },
    {
      ...
      opcions: [
        'Cada relació correspon a una entitat',
        'Cada relació correspon a una funcionalitat',
        'Cada relació correspon a un concepte semàntic',
        'Cada relació correspon a una classe',
      ],
      correcta: 2,
    },
    {
      pregunta:
        'Una clau primària correspon a ... entre la instància i el valor',
      opcions: [
        'Una funció exhaustiva',
        'Una funció injectiva',
    ...
    {
      pregunta:
        'Una clau primària i un altre atribut de la mateixa relació poden estar relacionats amb...',
      opcions: [
        'Una funció exhaustiva',
        'Una funció injectiva',
        'Una funció bijectiva',
    ...
    {
      pregunta:
        'Una dependència funcional de X a Y ({X} → {Y}) vol dir que si sabem el valor de X, podem saber el de Y.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Una dependència funcional plena és una dependència funcional amb un únic atribut a la part dreta.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Una relació està en 1NF si tots els seus atributs són atòmics (és a dir, indivisibles).',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Una relació està en 2NF si totes les dependències funcionals cap als atributs que no formen part d'una clau són plenes.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Una relació està en 3NF si cap dels seus atributs està a la part esquerra d'una dependència funcional.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    },
    {
      ...
      opcions: [
        ...
        'Transitivitat',
        'Distributivitat',
        'Pseudo-transitivitat',
        'Adició',
        'Projectabilitat/Descomposició',
      ],
      correcta: 3,
    },
    {
      pregunta:
        'Què NO puc deduir a partir de la clausura de dependències funcionals?',
      opcions: [
        'Si un esquema és correcte',
        'Tot el conjunt de claus candidates',
        'Si una dependència funcional és certa o no',
        'Si dos esquemes relacionals són equivalents',
      ],
      correcta: 0,
    },
    {
      pregunta:
        "Amb l'algorisme de normalització d'anàlisi es poden perdre dependències funcionals.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Donades les dependències funcionals, la normalització es pot automatitzar totalment.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      ...
      opcions: [
        'Quan les taules s’haurien d’ajuntar (join) molt sovint',
        'Quan la base de dades és molt petita',
        'Quan la consistència de les dades es pot garantir d’alguna altra manera',
        'Quan no s’esperen canvis a les dades',
      ],
      correcta: 1,
    },
    {
      pregunta:
        'La BCNF es va definir perquè 2NF i 3NF no garanteixen l’absència d’anomalies.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'Les anomalies a les que fa referència la normalització no afecten a les consultes.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'La normalització formalitza les propietats que ha de complir un disseny de bases de dades relacionals per a ser considerat de qualitat.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'El producte cartesià de dos conjunts és també un tipus de relació, però no funcional.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'El principal propòsit de les formes normals del model relacional és millorar el rendiment (és a dir, temps de resposta) del sistema.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'Si una relació que no està en 2FN i volem que ho estigui, el que hem de fer és dividir els seus atributs en subconjunts disjunts tant com calgui fins que ho estigui.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Si una relació que no està en 3FN i volem que ho estigui, el que hem de fer és dividir els seus atributs en subconjunts disjunts tant com calgui fins que ho estigui, però deixant en cada divisió com clau forana entre les parts el determinant que provoca la violacio de la forma normal.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'La clausura de dependències funcionals conté totes les dependències implícites al disseny.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Si executem l'algorisme de normalització d'anàlisi diverses vegades, podem obtenir resultats diferents.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "L'algorisme de normalització d'anàlisi NO garanteix que al final complim BCNF.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "L'algorisme de normalització d'anàlisi tracta de trobar la 'relació universal'.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Un esquema normalitzat és millor que un que no ho està, perquè el primer conté redundàncies que el segon no té.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Donada la seqüència de conjunts d'esquemes tals que compleixen una certa dependència funcional: E1NF, E2NF, E3NF, EBCNF i E4NF (per exemple, E3NF representa tots el esquemes que compleixen 3NF). Si considerem qualsevol parella EX-EY tal que EX apareix abans que EY en aquesta seqüència, podem afirmar que:",
      opcions: [
        'EX ∩ EY = ∅ (no hi ha cap esquema que compleixi X i Y alhora)',
        'EX ⊇ EY (tots els que compleixen Y, també compleixen X)',
        'EX ⊆ EY (tots els que compleixen X, també compleixen Y)',
        'Cap de les anteriors',
      ],
      correcta: 1,
    },
    ...
    {
      pregunta:
        'Una dependència multivaluada és un tipus de dependència funcional.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Per normalitzar una relació que no estigui en 4FN, hem de fer el producte cartesià del atributs que l'estiguin violant.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
  ],
  tema4: [
    ...
    {
      pregunta:
        "Quina NO és una de les quatre característiques d'un magatzem de dades?",
      opcions: [
        'No volàtil',
        'Integrat',
        'Orientat a temes',
    ...
    {
      pregunta:
        "Quina diferència hi ha entre una arquitectura d'un sol nivell i una de dos d'emmagatzemament de dades (data warehousing)?",
      opcions: [
        "La d'un nivell no té cap base de dades",
        "La d'un nivell no té cap base de dades operacional",
        "La d'un nivell no té cap base de dades decisional",
        'Cap de les anteriors',
      ],
      correcta: 2,
    },
    {
      ...
      opcions: [
        "Encapsular l'accés a les dades",
        'Carregar les dades a una base de dades',
        'Treure dades de les fonts',
        'Netejar les dades',
      ],
      correcta: 0,
    },
    ...
    {
      pregunta:
        'Les bases de dades decisionals sempre actualitzen les dades en temps real.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Les bases de dades decisionals NO necessiten control de concurrència.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      ...
      opcions: [
        'Respon consultes ràpidament',
        'Serveix per a fer anàlisi de dades',
        'Permet compartir dades',
        'Gestiona dades multidimensionals',
        'Integra dades',
      ],
      correcta: 4,
    },
    ...
    {
      pregunta:
        'Quina multiplicitat permet un esquema en estrella entre el fet i les dimensions?',
      opcions: ['1-1', '1-*', '*-*', 'Totes les anteriors'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Quantes claus primàries té la taula de fets d'un esquema en estrella?",
      opcions: [
        'Tantes com dimensions',
        'Una',
        'Tantes com dimensions menys una',
        'Un número indeterminat',
      ],
      correcta: 1,
    },
    {
      pregunta:
        "Quants atributs té la clau primària de la taula de fets d'un esquema en estrella?",
      opcions: [
        'Un',
        'Tants com dimensions menys una',
        'Tants com dimensions',
        'Un número indeterminat',
      ],
      correcta: 2,
    },
    {
      pregunta:
        "De quin tipus de valors faciliten el càlcul les clàusules 'GROUPING SETS'?",
      opcions: ['Agregats', 'Derivats', 'Atòmics', 'Marginals'],
      correcta: 3,
    },
    {
      pregunta:
        'Quin tipus de sistema NO forma part del suport a la presa de decisions?',
      opcions: [
        'Machine Learning',
        'ETL',
        'Reporting',
    ...
    },
    {
      ...
      opcions: [
        'Orientat a temes',
        'Orientat a la funcionalitat',
        'Orientat a decisions',
        'Orientat a transaccions',
      ],
      correcta: 0,
    },
    {
      pregunta:
        "Que un magatzem de dades sigui 'timevariant' vol dir que el software està en permanent evolució?",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Que un magatzem de dades sigui 'non-volatile' vol dir que mai s'esborra cap dada?",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Que un magatzem de dades sigui 'integrated' vol dir que els seus components de programari interactuen com si fos un sistema monolític?",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Una arquitectura d'un sol nivell d'emmagatzemament de dades (data warehousing), genera un magatzem de dades virtual.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "En una arquitectura de dos nivells d'emmagatzemament de dades (data warehousing), les dades es poden replicar com a màxim dues vegades.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Quina NO es considera una limitació dels fulls de càlcul per analitzar dades multidimensionals?',
      opcions: [
        'No gestiona metadades',
        "No permeten operacions d'àlgebra lineal",
        'Permet un número limitat de cel·les',
        'La posició de les dades limita certes operacions',
        "No gestiona jerarquies d'agregació",
      ],
      correcta: 1,
    },
    {
      pregunta:
        'Les eines OLAP guarden les dades en una estructura de dades física en forma de cub n-dimensional.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Les operacions de 'Slice&Dice' són seleccions sobre les dades.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Les operacions de 'Roll-up' i 'Drill-Down' indiquen agrupacions de dades.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Quin avantatge de la modelització de dades operacionals ens és útil també per modelitzar dades decisionals?',
      opcions: [
        'Facilita la comprensió del domini per part dels usuaris finals',
        'Resulta en sistemes molt eficients quan tenen canvis freqüents',
        'Redueix la quantitat de dades redundants',
        'Elimina la necessitat de modificar molts registres per un sol canvi',
      ],
      correcta: 0,
    },
    {
      ...
      opcions: [
        'Posar el focus en un tema concret',
        "Simplificar l'esquema conceptual",
        'Tots dos',
        'Cap dels dos',
      ],
      correcta: 2,
    ...
    },
    {
      ...
      opcions: [
        'Emmagatzemament i consulta',
        'Consulta i traducció',
        'Emmagatzemament i traducció',
        'Tots els anteriors',
      ],
      correcta: 2,
    },
    ...
    {
      pregunta:
        'El principal problema de les eines ROLAP és que generen massa joins.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Els sistemes OLAP i OLTP implementats sobre SGBDs relacionals segueixen les mateixes tres fases de disseny.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Una Cube-Query fa tantes joins com dimensions tingui el cub més una.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Una Cube-Query sobre una eina ROLAP retorna una taula relacional.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'Qualsevol consulta que utilitzi ROLLUP i/o CUBE, sempre es pot rescriure utilitzant només GROUPING SETS.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Sempre que es pugui, és millor utilitzar ROLLUP i/o CUBE, en lloc de GROUPING SETS, perquè facilita l'optimització de la consulta.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
  ],
  tema5: [
    {
      pregunta:
        "Els SGBDs relacionals permeten implementar qualsevol tipus de sistema d'informació de forma eficient.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Els sistemes NOSQL garanteixen les restriccions d'integritat, tal com fan els sistemes relacionals.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Quina NO és una conseqüència d'acceptar la variabilitat de l'esquema?",
      opcions: [
        'Es guanya en flexibilitat',
        'Es perd semàntica',
        "Es perd el principi d'independència de dades",
        'Es guanya eficiència en les consultes',
      ],
      correcta: 3,
    },
    {
      pregunta:
        "La independència física, d'acord amb l'arquitectura ANSI/SPARC, garanteix que un canvi en l'esquema intern no afectarà a les taules de la base de dades.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "La independència lògica, d'acord amb l'arquitectura ANSI/SPARC, garanteix que un canvi en les vistes no afectarà a les taules de la base de dades.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Un SGBD relacional pot contenir una base de dades que segueixi a la vegada el model relacional i corelacional.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Un atribut multivaluat guardat en un array generarà tants accessos a disc com elements tingui l'array.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Un atribut multivaluat guardat en un array ocuparà més espai de disc que guardant-ho per files, però menys que fent-ho per columnes.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "En general, la funció per calcular agregats a partir d'un array, l'ha de definir l'usuari.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'El nivell de concurrència que permet guardar un atribut multivaluat en un array és el mateix que si el guardem per columnes.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'Quan tenim documents JSON, els hem de guardar en un SGBD relacional utilitzant el tipus de dades corresponent.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'Impedance mismatch vol dir que el format de les dades al disc i a la memoria és diferent.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "El fet de niar unes instàncies dins d'unes altres trenca la 1NF.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "La independència lògica, d'acord amb l'arquitectura ANSI/SPARC, garanteix que un canvi en una taula no afectarà a cap vista de la base de dades, tret que el canvi afecti els atributs o taules utilitzats en la vista.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "En PostgreSQL, per canviar el valor d'una posició concreta d'un array, hem de reassignar tot l'array complet a la fila corresponent.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Un array en PostgreSQL té un nombre fix de valors, indicat en la seva declaració.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "PostgreSQL disposa de funcions booleanes específiques que permeten definir fàcilment restriccions d'integritat sobre cadascun dels elements d'un array.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "La principal diferència entre un gestor de documents i un de parelles clau-valor és que el primer aprofita l'estructura dels documents per a permetre la definició d'índexs secundaris.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'El principal propòsit de niuar diferents instàncies en un mateix document JSON és evitar joins.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "En un gestor de documents, podem definir l'esquema que aquests han de seguir.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Un gestor de documents guarda sempre al disc exactament el mateix que posa a la memòria.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "El tipus JSONB de PostgreSQL preserva l'ordre de les claus al document.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'El tipus JSONB de PostgreSQL elimina claus duplicades al document.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Podem tenir un document JSON que compleixi la mateixa propietat de la BCNF (és a dir, cada determinant determina per ell mateix tots els atributs del document, ja sigui directa o indirectament).',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
  ],
  tema6: [
    {
      pregunta:
        'Quin NO és un dels quatre nivells de l’arquitectura ANSI/SPARC?',
      opcions: ['Conceptual', 'Internal', 'External', 'Lògic'],
      correcta: 3,
    },
    {
      pregunta:
        'Quina de les següents possibilitats no existeix en els SGBDs relacionals?',
      opcions: [
        'Taules materialitzades',
        'Vistes materialitzades',
        'Taules no materialitzades',
    ...
    },
    {
      ...
      opcions: [
        'Comprovar restriccions d’integritat',
        'Simplificar el manteniment',
        'Amagar dades',
        'Simplificar esquemes complexos',
    ...
    {
      pregunta:
        'Els SGBDs sempre permeten modificar una taula a través d’una vista que no conté cap altra taula.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Els SGBDs sempre permeten modificar una taula a través d’una vista que tingui un agregat.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Els SGBDs sempre permeten modificar una taula a través d’una vista que faci una join.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Quan NO podem propagar els canvis d’una taula a les seves vistes materialitzades?',
      opcions: [
        'Next <date>',
        'On commit',
        'On statement',
        'On demand',
        'Podem propagar-los de totes les maneres anteriors',
      ],
      correcta: 4,
    },
    {
      pregunta:
        'Només cal crear un log per fer manteniment de vistes incremental.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Sempre podem utilitzar una vista materialitzada per implementar una asserció.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Per implementar una asserció amb una vista materialitzada, cal que la vista sempre estigui buida.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Quin NO és un dels requisits per a poder rescriure una consulta en termes d’una vista materialitzada?',
      opcions: [
        'Les taules utilitzades a la consulta han de ser un subconjunt de les que hi ha a la vista',
        'El nivell d’agregació de la consulta ha de ser tan alt o més que el de la vista',
        'El predicat de la consulta ha d’estar subsumit pel de la vista',
        'Els agregats de la vista han de coincidir o ser calculables a partir dels de la vista',
      ],
      correcta: 0,
    },
    {
      pregunta:
        'Si, en general, utilitzar vistes materialitzades millora el rendiment de les consultes, NO és perquè ...',
      opcions: [
        'tenen menys atributs',
        'generen menys accessos a disc',
        'generen menys contenció',
        'ocupen menys espai',
        'tenen menys files',
      ],
      correcta: 2,
    ...
    {
      pregunta:
        'Si el nostre SGBD no proporciona vistes materialitzades, podríem implementar-les nosaltres mateixos amb disparadors.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Quan es varen introduir les vistes materialitzades a l’estàndard SQL?',
      opcions: ['Al seu inici', 'Al 1992', 'Al 2023', 'Encara no ho estan'],
      correcta: 3,
    },
    {
      pregunta:
        'Només tenint en compte les diferents possibilitats d’agregació, el nombre de potencials vistes materialitzades que podem crear ja és exponencial.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Quina NO és una bona heurística per a triar quines vistes materialitzar en un esquema multidimensional?',
      opcions: [
        'Materialitzar els nivells d’agregació més baixos',
        'Materialitzar els nivells d’agregació més alts',
        'Materialitzar una vista si coincideix amb una consulta crítica',
        'No materialitzar una vista si ja s’ha materialitzat una altra que és un ancestre proper en la jerarquia d’agregació',
        'Totes les heurístiques anteriors són bones',
      ],
      correcta: 4,
    },
    {
      pregunta:
        'Hem de considerar com a vista candidata a materialitzar la que conté un “GROUP BY” que és la intersecció dels “GROUP BY” de dues consultes crítiques.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "En quin nivell de l'arquitectura ANSI/SPARC trobem més esquemes?",
      opcions: [
        'Internal',
        'Conceptual',
        'External',
        'Trobem a tots el mateix nombre',
      ],
      correcta: 2,
    },
    {
      pregunta:
        'La consulta que defineix una vista sempre està guardada al catàleg de la base de dades.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    },
    {
      ...
      opcions: [
        ...
        'View expansion',
        'View updating',
        'Tots quatre problemes apliquen a qualsevol tipus de vista',
      ],
      correcta: 2,
    },
    {
      ...
      opcions: [
        'Quan modifiquem una taula',
        'Quan consultem una vista',
        'Quan modifiquem una vista',
        'Quan consultem una taula',
      ],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        "Quants dels tres problemes teòrics que tenen associats a les vistes materialitzades podem veure explícitament reflectits a la seva sentència de creació d'Oracle?",
      opcions: ['Cap', 'Un', 'Dos', 'Tres'],
      correcta: 3,
    },
    {
      pregunta:
        'View Expansion consisteix simplement en substituir el nom de la vista que apareix a la consulta per la corresponent definició que podem trobar al catàleg de la base de dades.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Update Through Views consisteix a utilitzar les vistes en comptes dels índexs per accedir més ràpid a les dades quan les hem de modificar.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Els SGBDs permeten modificar una taula a través d'una vista independentment del predicat lògic que es posi al WHERE de la definició de la vista, sempre que aquest no contingui cap subconsulta.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Els SGBDs permeten modificar una taula a través d'una vista definida sobre una altra vista si les dues definicions de les vistes compleixen, per separat, les condicions necessàries.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'View Updating consisteix a propagar els canvis que es produeixen a una taula a totes les vistes materialitzades definides sobre ella.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        'Hem de crear un únic log a cada taula que tingui vistes materialitzar a mantenir de forma incremental, independentment del seu nombre.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Fer el manteniment d'una vista materialitzada de forma incremental sempre és el més eficient.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Sempre es pot fer el manteniment d'una vista materialitzada de forma incremental si el log conté les dades adequades.",
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
      pregunta:
        "Query Rewriting consisteix en que l'usuari rescrigui la seva consulta aprofitant les vistes materialitzades existents, en comptes de les taules.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "En general, els SGBDs fan una cerca exhaustiva de totes les possibilitats de rescriptura d'una consulta emprant les vistes materialitzades que s'hagin definit amb anterioritat.",
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Per decidir si val la pena materialitzar o no una certa consulta, cal tenir en compte...',
      opcions: [
        "la freqüència amb que s'executa",
        "l'espai que ocuparà el seu resultat",
        'la freqüència amb que es modifiquen les taules que accedeix',
        'totes les anteriors',
      ],
      correcta: 3,
    },
    {
      pregunta:
        'Les vistes materialitzades que podem materialitzar ve limitat per...',
      opcions: [
        "l'espai disponible en el disc",
        'el temps disponible per fer el seu manteniment',
        'totes les anteriors',
        'cap de les anteriors',
      ],
      correcta: 2,
    ...
    {
      pregunta:
        'Utilitzant un algorisme greedy, sempre tindrem el conjunt òptim de vistes materialitzades.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Utilitzant un algorisme greedy, mai tindrem el conjunt òptim de vistes materialitzades.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        'Si hem utilitzat un algorisme greedy per seleccionar-les, ja no hem de canviar mai el conjunt de vistes que hem decidit materialitzar.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
      pregunta:
        "Podem estimar la cardinalitat del resultat d'una consulta amb agregats sobre la taula T(a1, ..., an) com...",
      opcions: [
        '| T |',
        'dist(a1) · ... · dist(an)',
        'min(| T |, dist(a1) · ... · dist(an))',
        'max(| T |, dist(a1) · ... · dist(an))',
      ],
      correcta: 2,
    },
  ],
  tema7: [
    ...
    {
      pregunta:
        'Posar índexs mai empitjorarà el temps de resposta del sistema.',
      opcions: ['Cert', 'False'],
      correcta: 1,
    },
    {
  ...
  tema8: [
    ...
    {
      pregunta:
        'L’optimitzador de consultes sempre troba el millor pla d’accés.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'L’optimització semàntica pot fer més llarga la clàusula WHERE.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
  ...
  tema11: [
    ...
    {
      pregunta:
        'Reduir el fillfactor sempre fa que les taules ocupin més espai.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
    ...
    {
      pregunta:
        'Quin tipus d’usuari s’encarrega del tuning de la base de dades?',
      opcions: [
        'Dissenyador',
  ...
  tema12: [
    {
      pregunta:
        'Pel que fa a l’aïllament, volem tenir només històries serials.',
      opcions: ['Cert', 'Fals'],
      correcta: 1,
    },
    {
    ...
    {
      pregunta:
        'Mentre s’executa un backup, el rendiment del sistema empitjora.',
      opcions: ['Cert', 'Fals'],
      correcta: 0,
    },
    {
